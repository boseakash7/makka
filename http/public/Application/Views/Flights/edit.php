                ...
                <div class="card-body">
                    <form action="<?php echo URL::current() ?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="saudi_date" id="saudi_date" value="<?php echo $formValidator->getValue('saudi_date', $flight['saudi_date']); ?>"/>
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" name="saudi_time" id="saudi_time" value="<?php echo $formValidator->getValue('saudi_time', $flight['saudi_time']); ?>"/>
