                    ...
                    <form action="<?php echo URL::current() ?>" method="POST">
                        ...
                        <div class="row">
                            <div class="col form-group">
                                ...
                                <input type="number" class="form-control" name="average_pilgrim_waiting" id="average_pilgrim_waiting" value="<?php echo $formValidator->getValue('average_pilgrim_waiting', $departureInfo['arr']['average_pilgrim_waiting']); ?>" placeholder="<?php echo $lang('in_minutes') ?>"/>
                            ...
                            <div class="col form-group">
                                ...
                                <input type="number" class="form-control" name="average_pilgrim_service" id="average_pilgrim_service" value="<?php echo $formValidator->getValue('average_pilgrim_service', $departureInfo['arr']['average_pilgrim_service']); ?>" placeholder="<?php echo $lang('in_minutes') ?>" />
