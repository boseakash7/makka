                ...
                <form action="<?php echo URL::current() ?>" method="POST">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" name="first_hajji_arrived_time" id="first_hajji_arrived_time" value="<?php echo $formValidator->getValue('first_hajji_arrived_time'); ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" name="last_hajji_arrived_time" id="last_hajji_arrived_time" value="<?php echo $formValidator->getValue('last_hajji_arrived_time'); ?>" />
                        ...
                        <div class="form-group">
                            ...
                            <input type="time" class="form-control" name="first_bus_leave_time" id="first_bus_leave_time" value="<?php echo $formValidator->getValue('first_bus_leave_time'); ?>" />
