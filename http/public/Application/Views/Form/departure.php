                    ...
                    <form action="<?php echo URL::current() ?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="speed_of_communication" class="form-control" value="<?php echo $formValidator->getValue('speed_of_communication') ?>" id="speed_of_communication">
