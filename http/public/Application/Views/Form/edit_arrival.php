                    ...
                    <form action="<?php echo URL::current() ?>" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col form-group">
                                ...
                                <input type="text" class="form-control" name="expected_arrival_time" id="expected_arrival_time" value="<?php echo $formValidator->getValue('expected_arrival_time', $arrivalInfo['arr']['expected_arrival_time']); ?>" placeholder="hh:mm:ss"/>
